...
import image16 from '../../../assets/images/HomePage/image16.jpg';
import image0 from '../../../assets/images/HomePage/image0.jpg';
...
import consulting from '../../../assets/images/HomePage/consulting.jpg';
import image18 from '../../../assets/images/HomePage/image18.jpg';
    ...
    return (
        <div className="content">
            ...
            <div class="main">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p>Aditep Civils is an industry leader in Civil Engineering, Road Construction and Rehabilitation works.
                        Aditep Civils has been in construction for the past 20 years and has completed projects that encompass the full spectrum of civil engineering services. These include road construction, infrastructure development, parking area construction, road rehabilitation, bulk earthworks and surfacing.
                        Our site management teams are dynamic, skilled and have very good experience in all facets of civil engineering construction. We take pride in delivering successful projects on time, within budget and to the highest quality standards.
            ...
            <div class="main">
                ...
                <p>Aditep (Pty) Ltd's growth has been a remarkable one. It was established as a firm offering "traditional" consulting services in the fields of civil, structural, Site investigation and feasibility study, Compilation of Business Plan, 
                ...
                <ul class="cards">
                    <li class="cards_item">
                        <div class="card">
                            <div class="card_image"><img src={image16} /></div>
                            <div class="card_content">
                                <h6 class="card_title">Civil Engineering</h6>
                                <p class="card_text">Aditep Civils offers the full range of civil engineering services, from large-scale earthworks and infrastructure projects, to resident developments, including Road and stormwater, Water and Sewer Reticulation.</p>
                    ...
                    <li class="cards_item">
                        <div class="card">
                            <div class="card_image"><img src={image15} /></div>
                            <div class="card_content">
                    ...
                    <li class="cards_item">
                        <div class="card">
                            <div class="card_image"><img src={consulting} /></div>
                            <div class="card_content">
                    ...
                    <li class="cards_item">
                        <div class="card">
                            <div class="card_image"><img src={image18} /></div>
                            <div class="card_content">
                                <h6 class="card_title">Dig B Plant Hire</h6>
                                <p class="card_text">Aditep is a multifaceted company in the field of seals, asphalting and road rehabilitation.
                    ...
                    <li class="cards_item">
                        <div class="card">
                            <div class="card_image"><img src={image19} /></div>
                            <div class="card_content">
                                <h6 class="card_title">Herb Service</h6>
                                <p class="card_text">Aditep is a multifaceted company in the field of seals, asphalting and road rehabilitation.
                                We regard ourselves as an efficient company striving to be the leader in our field. We deliver quality work on time and within specification.
                                </p>
                                <button class="btn card_btn">Read More</button>
            ...
            <div className='countup-section'>
                <div class="row">
                    <div class="col-md-3">
                        <strong><CountUp end={1939} duration={10} /></strong>
                        <h6>Year Established</h6>
                    </div>
                    <div class="col-md-3 col-md-offset-2">
                        <strong><CountUp end={207} duration={10} /></strong>
                        <h6>Years Combined Experience</h6>
                    </div>
                    <div class="col-md-3 col-md-offset-2">
                        <strong><CountUp start={500} end={169} duration={10} /></strong>
                        <h6>Projects Completed</h6>
                    </div>
                    <div class="col-md-3 col-md-offset-2">
                        <strong><CountUp end={54} duration={10} /></strong>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <figure>
                        ...
                        <figcaption>The Civil Service Group falls under the Civil, Water, Bridges, Roads and Rail Business Unit and has a number of operational Design Centres in many of the Aditep offices.</figcaption>
                    </figure>
                </div>
                <div class="col-sm-4">
                    <figure>
